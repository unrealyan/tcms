...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/tcms/flexsearch.min.js');loadScript('/tcms/en.search-data.min.5a716a91b858423202324cbe336860eda0d055c651b18988edf7857fdfc1c87f.js',function(){input.required=false;search();});}
